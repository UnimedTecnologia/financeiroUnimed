                ...
                <div class="card-body">
                    <form id="formCopart">
                        ...
                        <div class="d-grid mt-3">
                            <button id="btnRelCopart" type="submit" class="btn btn-success btn-lg">
...
document.getElementById("formCopart").addEventListener("submit", async function(e) {
    ...
    const btn = document.getElementById("btnRelCopart");
    ...
    let filename = "relatorio_coparticipacao.xlsx";
