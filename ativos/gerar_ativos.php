...
u.cd_usuario, to_char(CI.CD_UNIMED||ci.CD_CARTEIRA_INTEIRA) AS CARTEIRINHA, u.NM_USUARIO AS NOME, to_char(u.DT_INCLUSAO_PLANO,'dd/mm/yyyy') AS DATA_INCLUSAO_PLANO,
